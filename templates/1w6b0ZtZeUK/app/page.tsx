...
export default function ClipsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#191919]">
      ...
      >
        <main ref={mainRef} className="flex-1 min-h-screen p-8 pt-16">
          <div className="mx-auto" style={{ width: "912px" }}>
            <div className="flex items-center justify-between h-12 mb-6">
              <h1 className="text-xl font-semibold text-white tracking-tight">Clips</h1>
              <button
                className="text-sm font-medium text-black rounded-lg hover:bg-white/90 transition-colors py-1.5 bg-card-foreground px-3"
                onClick={(e) => {
